...
export const NO_ROOMS = `คุณยังไม่มีห้องที่เข้าร่วมอยู่ครับ กรุณาให้ผู้ดูแลเพิ่มคุณในห้อง หรือสร้างห้องผ่าน LIFF 👇`;

export const ROOM_SWITCH_LOCKED = 'คุณกำลังใช้งานห้องนี้อยู่ กรุณากด "ออกจากห้อง" ก่อนเปลี่ยนห้องครับ 🙏';
export const ROOM_LEFT = 'ออกจากห้องเรียบร้อยครับ เลือกห้องที่ต้องการจัดการได้เลย 👆';
