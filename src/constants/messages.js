...
// ---------- การชำระเงิน ----------
export const NO_PERIODS = `ไม่มีรายการที่ต้องชำระในขณะนี้ครับ 🎉`;

export const SEND_SLIP_PROMPT = `👉 โอนเสร็จแล้ว ส่งรูปสลิปเข้ามาในแชทนี้ได้เลยครับ 📸`;

export const NO_PENDING_SLIP = `❌ ไม่พบรายการรอสลิป กรุณากด "💸 จ่ายเงิน" เพื่อเลือกรายการที่ต้องการจ่ายก่อนครับ`;
export const slipSaved = (name) =>
  `✅ บันทึกสลิปสำหรับ "${name}" เรียบร้อยแล้วครับ!\nแอดมินจะทำการตรวจสอบเร็วๆ นี้ครับ ⏳`;
...
export const ALT_PERIOD_LIST = `รายการชำระเงิน`;
